...
export class ParcoursGlossary {
  ...
  async load() {
    ...
    // Calcule le chemin relatif : depuis epicPath (ex: ../../), remonter vers parcours/
    const globalPath = `${this.epicPath}/../glossary.json`;
    const globalTerms = await this._loadGlossaryFile(globalPath);
